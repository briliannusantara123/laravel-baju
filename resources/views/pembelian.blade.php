                        ...
                        <div class="row">
                            <div class="col-sm-12">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control option-w3ls" style="width: 100%; height: 50px;" name="status" id="status">
   ...
   <div class="col-sm-offset-2 col-sm-12">
    ...
    <script>
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('pembelian.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('pembelian/' + data_id + '/edit', function (data) {
                $('#modal-judul').html("Ubah Status");
                $('#tombol-simpan').val("Ubah Status");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "pembelian/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
