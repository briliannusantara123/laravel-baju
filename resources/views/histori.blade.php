   ...
   <div class="main">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><b>Jika menghapus HistoriHistori maka</b></p>
                    <p>*data HistoriHistori tersebut hilang selamanya, apakah anda yakin?</p>
                </div>
    ...
    <script>
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('histori.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('histori/' + data_id + '/edit', function (data) {
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "histori/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
